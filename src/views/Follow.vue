		...
		<div v-for="(moment,index) in momentsList" :key="index" class="border-bottom ">
			<v-list>
				...
				<div v-if="!flag[index]">
					...
					<div class="hy-moments-card-content d-flex " v-if="moment.target.thumbnail">
						<div class="hy-moments-card-content-left col-4">
							<img :src="moment.target.thumbnail" alt="">
						</div>
						<div class="hy-comments-card-content-right col-8">
				...
				<!-- 点击阅读全文出现全部内容 -->
				<div class="hy-moments-card-answer pl-5 pr-5 mt-1" v-if="flag[index]">
				...
				<div :class="flag[index]?'hy-moments-hideLine pos-sti hy-moments-hideLine-more pl-3' :'hy-moments-hideLine   pl-3'">
					...
					<span class="mt-5 ml-5 hy-moments-card-span">
					...
					<span class="mt-5 offset-l-2 hy-moments-card-span link" v-if="flag[index]" @click="getPackUp(index)">
						收起
...
<style scoped="scoped">
	...
	.hy-moments-card-content-left {
		/* background-color: #808080; */
	}

	.hy-comments-card-content-right {
		/* background-color: #0C89FF; */
	}

	.hy-moments-card-answer {
