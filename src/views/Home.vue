	...
	<div class="d-flex">
		...
		<div class="col-4">
			...
			<div class="hy-home-right-bottom fill-white mt-1 border-bottom d-flex flex-wrap">
				...
				<div class="hy-home-right-box d-flex justify-content-center align-items-center flex-column">
					<svg class="Zi Zi--Ebook" fill="currentColor" color="#43d480" viewBox="0 0 24 24" width="24" height="24">
				...
				<div class="hy-home-right-box d-flex justify-content-center align-items-center flex-column">
					<svg class="Zi Zi--Org" fill="currentColor" color="#0084ff" viewBox="0 0 24 24" width="24" height="24">
				...
				<div class="hy-home-right-box d-flex justify-content-center align-items-center flex-column">
					<svg class="Zi Zi--Edit" fill="currentColor" color="#0f88eb" viewBox="0 0 24 24" width="24" height="24">
				...
				<div class="hy-home-right-box d-flex justify-content-center align-items-center flex-column">
					<svg class="Zi Zi--Infinity" fill="currentColor" color="#5478f0" viewBox="0 0 24 24" width="24" height="24">
				...
				<div class="hy-home-right-box d-flex justify-content-center align-items-center flex-column">
					<svg class="Zi Zi--KnowledgeBase" fill="currentColor" color="#5868d1" viewBox="0 0 24 24" width="24" height="24">
